...
PreparedStatement ps = con.prepareStatement("update company set companytanno='"+s2+"',yearofestablishment='"+s3+"',companyceo='"+s4+"',headoffice='"+s5+"',phoneno='"+s6+"',email='"+s7+"',employees='"+s8+"',branches='"+s9+"',address='"+s10+"',website='"+s11+"',password='"+s12+"'  where companyname='"+s1+"'");
