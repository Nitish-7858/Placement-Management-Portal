...
PreparedStatement ps = con.prepareStatement("insert into upcompany values(?,?,?,?,?,?,?,?,?,?)");
ps.setString(1,s1);
ps.setString(2,s2);
ps.setString(3,s3);
ps.setString(4,s4);
...
con.close();
%>
<p style="background: linear-gradient(red,blue);background-clip: text;color: transparent;font-size: 50px;margin-top: 60px;text-align: center;"> your record have been submited succefully</p>
</body>
</html>